...
class VideoProcessingConsumer(
    @Value("\${messaging.topics.video-processing}") private val topic: String,
    @Value("\${messaging.group}") private val group: String,
    private val natsConnection: NatsConnection,
    private val objectMapper: ObjectMapper,
    private val videoProcessingHandler: VideoProcessingHandler
) {
    ...
    private fun handle(message: Message) {
        ...
        runBlocking { videoProcessingHandler.handle(video) }
    }
}
